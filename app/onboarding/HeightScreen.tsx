...
export default function HeightScreen() {
  ...
  const saveHeight = async () => {
    if (auth.currentUser) {
      ...
      await setDoc(userRef, { height }, { merge: true });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <TouchableOpacity style={styles.adjustButton} onPress={() => setHeight((prev) => prev - 1)}>
      ...
      <View style={styles.navigation}>
        ...
        <TouchableOpacity style={styles.navButton} onPress={saveHeight}>
